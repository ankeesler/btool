...
import (
	...
	"github.com/ankeesler/btool/node/pipeline/handlers/deps"
	"github.com/ankeesler/btool/node/pipeline/handlers/deps/depsfakes"
...
func wireFakeDownloader() *depsfakes.FakeDownloader {
	d := &depsfakes.FakeDownloader{}
	return d
}
