...
// TEST(IncTest, UnknownInclude) {
//  ::btool::app::collector::Store s;
//  auto tuna_c = s.Put("tuna.c");
//  ::btool::app::collector::Properties::SetLocal(tuna_c->property_store(),
//  true);
//
//  ::btool::app::collector::testing::SpyCollectini sc;
//  FakeIncludesParser fip;
...
//
//  EXPECT_THAT(sc.on_notify_calls_, ElementsAre());
//
//  auto some_path_h = s.Put("some/path.h");
//  ::btool::app::collector::Properties::SetLocal(some_path_h->property_store(),
//                                                true);
//  i.OnNotify(&s, "some/path.h");
//
//  deps = s.Get("tuna.c")->dependencies();
//  EXPECT_EQ(1UL, deps->size());
//  EXPECT_EQ("some/path.h", deps->at(0)->name());
