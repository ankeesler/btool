...
type FakeCollector struct {
	CollectStub        func(*node.Node) (*node.Node, error)
...
func (fake *FakeCollector) Collect(arg1 *node.Node) (*node.Node, error) {
...
func (fake *FakeCollector) CollectCalls(stub func(*node.Node) (*node.Node, error)) {
	fake.collectMutex.Lock()
...
func (fake *FakeCollector) CollectReturns(result1 *node.Node, result2 error) {
	fake.collectMutex.Lock()
	defer fake.collectMutex.Unlock()
...
func (fake *FakeCollector) CollectReturnsOnCall(i int, result1 *node.Node, result2 error) {
	fake.collectMutex.Lock()
	defer fake.collectMutex.Unlock()
	fake.CollectStub = nil
...
var _ btool.Collector = new(FakeCollector)
