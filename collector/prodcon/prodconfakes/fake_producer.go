...
type FakeProducer struct {
	ProduceStub        func(*prodcon.Store) error
...
func (fake *FakeProducer) Produce(arg1 *prodcon.Store) error {
...
func (fake *FakeProducer) ProduceCalls(stub func(*prodcon.Store) error) {
	fake.produceMutex.Lock()
	defer fake.produceMutex.Unlock()
	fake.ProduceStub = stub
}

func (fake *FakeProducer) ProduceArgsForCall(i int) *prodcon.Store {
	fake.produceMutex.RLock()
	defer fake.produceMutex.RUnlock()
...
var _ prodcon.Producer = new(FakeProducer)
