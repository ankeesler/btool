...
type FakeConsumer struct {
	ConsumeStub        func(*prodcon.Store, *prodcon.Diff) error
...
func (fake *FakeConsumer) Consume(arg1 *prodcon.Store, arg2 *prodcon.Diff) error {
...
func (fake *FakeConsumer) ConsumeCalls(stub func(*prodcon.Store, *prodcon.Diff) error) {
	fake.consumeMutex.Lock()
	defer fake.consumeMutex.Unlock()
	fake.ConsumeStub = stub
}

func (fake *FakeConsumer) ConsumeArgsForCall(i int) (*prodcon.Store, *prodcon.Diff) {
	fake.consumeMutex.RLock()
	defer fake.consumeMutex.RUnlock()
...
var _ prodcon.Consumer = new(FakeConsumer)
